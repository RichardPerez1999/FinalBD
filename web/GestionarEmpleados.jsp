<%-- 
    ...
    Created on : 29/10/2018, 12:46:08 AM
...
<html lang="en">
      ...
      <div class="container">
        <div class="search-warp">
          <div class="section-title text-white">
            <h2><span>Gestionar Empleados</span></h2>
          </div>
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              <!-- search form -->
              <form class="course-search-form"action="ControladorEmpleado" method="POST"> <input placeholder="Id_Emp" name="Id_Emp" type="text">
                <input class="last-m" placeholder="Nombre" name="Nombre" type="text"> <input

                  class="last-m" placeholder="Usuario" name="Usuario" type="text"> <input class="last-m"

                  placeholder="Clave" name="Clave" type="text"> <button class="site-btn btn-dark" name="agregar">Agregar</button><button class="site-btn btn-dark" name = "eliminar">Eliminar</button> <button class="site-btn btn-dark" name ="Cargar">Ver inventario</button>
  ...
  <%
                    if(request.getAttribute("lista")!=null){
                        List empleados = (List<Empleado>)request.getAttribute("lista");
                        for (int i = 0; i < empleados.size(); i++) {
                            Empleado empelado = (Empleado)empleados.get(i);
                            
                          
                    %>
                    <tr>
                        <td><%=empelado.getId_Emp()%></td>
                        <td><%=empelado.getNombre()%></td>
                        <td><%=empelado.getUsuario()%></td>
                        <td><%=empelado.getClave()%></td>
